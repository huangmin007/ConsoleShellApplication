...
namespace HPSocket
{
    ...
    /// </summary>
    [Description("通信组件服务状态,用程序可以通过通信组件的 GetState() 方法获取组件当前服务状态")]
    public enum ServiceState
    {
        /// <summary>
        /// 正在启动
        /// </summary>
        [Description("通信组件服务正在启动")]
        Starting = 0,

        /// <summary>
        /// 已经启动
        /// </summary>
        [Description("通信组件服务已经启动")]
        Started = 1,

        /// <summary>
        /// 正在停止
        /// </summary>
        [Description("通信组件服务正在停止")]
        Stoping = 2,
    ...
    /// </summary>
    [Description("Socket 操作类型,应用程序的 OnErrror() 事件中通过该参数标识是哪种操作导致的错误")]
    ...
    /// </summary>
    [Description("事件通知处理结果,事件通知的返回值，不同的返回值会影响通信组件的后续行为")]
    ...
    /// <summary>
    /// 名称：操作结果代码
    /// <para>描述：组件 Start() / Stop() 方法执行失败时，可通过 GetLastError() 获取错误代码</para>
    /// </summary>
    [Description("操作结果码, 组件 Start() / Stop() 方法执行失败时，可通过 GetLastError() 获取错误码")]
    public enum SocketError
    {
        ...
        /// 创建 SOCKET 失败
        /// </summary>
		[Description("创建 SOCKET 失败")]
        SocketCreate = 3,

        /// <summary>
        /// 绑定 SOCKET 失败
        /// </summary>
		[Description("绑定 SOCKET 失败")]
        SocketBind = 4,

        /// <summary>
        /// 设置 SOCKET 失败
        /// </summary>
		[Description("设置 SOCKET 失败")]
        SocketPrepare = 5,

        /// <summary>
        /// 监听 SOCKET 失败
        /// </summary>
		[Description("监听 SOCKET 失败")]
        SocketListen = 6,

        /// <summary>
        /// 创建完成端口失败
        /// </summary>
		[Description("创建完成端口失败")]
        CPCreate = 7,

        /// <summary>
        /// 创建工作线程失败
        /// </summary>
		[Description("创建工作线程失败")]
        WorkerThreadCreate = 8,

        /// <summary>
        /// 创建监测线程失败
        /// </summary>
		[Description("创建监测线程失败")]
        DetectThreadCreate = 9,

        /// <summary>
        /// 绑定完成端口失败
        /// </summary>
		[Description("绑定完成端口失败")]
        SocketAttachToCP = 10,
